...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'cedula',array('size'=>1,'maxlength'=>1)); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'telefono',array('size'=>1,'maxlength'=>1)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'login'); ?>
		<?php echo $form->textField($model,'login',array('size'=>60,'maxlength'=>254)); ?>
	</div>
